...
from napscheduler.triggers.simple import SimpleTrigger
from napscheduler.triggers.interval import IntervalTrigger
...
class TestJob(object):
    ...
    def test_getstate(self):
        ...
        eq_(state, dict(trigger=self.trigger,
                        ...
                        name=u'dummyfunc', args=[],
                        kwargs={}, misfire_grace_time=1,
                        coalesce=False, max_runs=None,
                        _observers=[], _observers_lock=self.job._observers_lock,
                        max_instances=1, active=True, runs=0))
